...
Pod::Spec.new do |s|
  s.name             = 'DuberPod'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DuberPod.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/solvire/DuberPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'solvire' => 'stevenjscott@gmail.com' }
  s.source           = { :git => 'https://github.com/solvire/DuberPod.git', :tag => s.version.to_s }
